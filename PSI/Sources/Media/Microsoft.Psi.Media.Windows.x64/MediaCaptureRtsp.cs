...
namespace Microsoft.Psi.Media
{
    ...
    /// </summary>
    public class MediaCaptureRtsp : IProducer<Shared<Imaging.Image>>, ISourceComponent, IDisposable, IMediaCapture
    {
        ...
        public MediaCaptureRtsp(Pipeline pipeline, Uri uri, NetworkCredential credential = null, bool captureAudio = false, bool persistVideoFrames = false, bool useInSharedMode = false)
    : this(pipeline)
        {
        ...
        private MediaCaptureRtsp(Pipeline pipeline)
        {
            ...
            this.Out = pipeline.CreateEmitter<Shared<Imaging.Image>>(this, nameof(this.Out));
        }
        ...
        /// </summary>
        public Emitter<Shared<Imaging.Image>> Video => this.Out;

        /// <summary>
        /// Gets the output stream of images.
        /// </summary>
        public Emitter<Shared<Imaging.Image>> Out { get; private set; }
        ...
        private Psi.Audio.WaveFormat ConvertAudioFormat(AudioFrameFormat format)
        {
            return Psi.Audio.WaveFormat.CreatePcm(format.SampleRate, format.BitPerSample, format.Channels);
        }
        ...
        private void ProcessAudioFrame(RawAudioFrame rawAudioFrame)
        {
            ...
            this.Audio.Post(new Psi.Audio.AudioBuffer(decodedFrame.DecodedBytes.Array, this.ConvertAudioFormat(decodedFrame.Format)), originatingTime);
        }
        ...
        private PixelFormat GetPsiPixelFormat(FFmpegPixelFormat pixelFormat)
        {
            ...
            {
                return Media.PixelFormat.Grayscale;
            }
            else
            {
