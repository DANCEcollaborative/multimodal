namespace SmartLab.Samples.JavaCommunicationSample
{
    using System;
    using System.Linq;
    using System.Net;
    ...
    {
        private const string AppName = "SmartLab PSI-Java Speech Communication Sample";
        ...
        public static void Main()
        {
            ...
            {
                Console.WriteLine("================================================================================");
                Console.WriteLine("                     SmartLab PSI-Java Speech Communication Sample");
                Console.WriteLine("================================================================================");
        ...
        public static void RunSystemSpeech(string outputLogPath = null, string inputLogPath = null)
        {
            ...
            {
                //Creat rtsp connection
                var serverUri = new Uri("rtsp://lorex5416b1.pc.cs.cmu.edu");
                var credentials = new NetworkCredential("admin", "54Lorex16");
                MediaCaptureRtsp webcam = new MediaCaptureRtsp(pipeline, serverUri, credentials, true);
                TimeSpan delay = TimeSpan.FromSeconds(5000);
